...
class AdminUser < ActiveRecord::Base
  ...
  attr_accessor :password # virtuálny atribút, ktorý nieje uložný v databáze 
  ...
  #callbacks- zastavia bykonávanie kódu v určitom okamžiku a vykonajú definovanú metódu
